...
**AdminLTE-AngularJs** -- is a fully responsive admin template. Based on **[Bootstrap 3](https://github.com/twbs/bootstrap)** framework. Highly customizable and easy to use. Fits many screen resolutions from small mobile devices to large desktops. Check out the live preview now and see for yourself.

**Preview on [AdminLTE-AngularJs](https://koushikdutta.github.io/AngularJs-AdminLte/)**

Installation
------------
There are multiple ways to install AdminLTE-AngularJs.
...
License
-------
AdminLTE-AngularJs is an open source project by [Almsaeed Studio](https://almsaeedstudio.com) that is licensed under [MIT](http://opensource.org/licenses/MIT). Almsaeed Studio
